...
class FullyConnected(Layer):
    ...
    def _init_parameters(self, X_shape: Tuple[int, int]) -> None:
        ...
        self.cache: OrderedDict = OrderedDict({"X": np.zeros((batch_size, self.n_in)), "Z": np.zeros((batch_size, self.n_out))})  # cache for backprop
        self.gradients: OrderedDict = OrderedDict({"W": np.zeros((self.n_in, self.n_out)), "b": np.zeros((self.n_out))})  # parameter gradients initialized to zero
